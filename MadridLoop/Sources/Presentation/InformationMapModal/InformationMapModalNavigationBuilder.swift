//
//  InformationMapModalNavigationBuilder.swift
//  MadridLoop
//
...
public protocol InformationMapModalNavigationBuilderContract: NavigationBuilder {
    func navigateToPetDetail(petId: String)
    func goBack()
}

open class InformationMapModalNavigationBuilder: InformationMapModalNavigationBuilderContract {
